# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-05-01 13:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_photo', models.ImageField(default='cover_photo/events/ntnui-volleyball.png', upload_to=events.models.Event.get_cover_upload_to)),
            ],
            options={
                'verbose_name': 'event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_end_date', models.DateTimeField(blank=True, null=True, verbose_name='registration end date')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Category', verbose_name='category')),
                ('waiting_list', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL, verbose_name='waiting list')),
            ],
            options={
