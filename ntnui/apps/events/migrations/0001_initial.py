# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-04-25 14:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_photo', models.ImageField(default='cover_photo/ntnui-volleyball.png', upload_to=events.models.event.Event.get_cover_upload_to)),
            ],
            options={
                'verbose_name': 'event',
        ...
        migrations.CreateModel(
            name='EventGuestWaitingListRegistration',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('registration_time', models.DateTimeField(verbose_name='registration time')),
                ('payment_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Payment id')),
        ...
        migrations.CreateModel(
            name='EventWaitingListRegistration',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('registration_time', models.DateTimeField(verbose_name='registration time')),
                ('payment_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Payment id')),
        ...
        migrations.CreateModel(
            name='GuestSubEventRegistration',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('registration_time', models.DateTimeField(verbose_name='registration time')),
                ('payment_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Payment id')),
